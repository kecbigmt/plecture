...
type TaskState struct {
	...
	// TaskID is the address the instance's declaration answers to. It is
	// omitted for a workflow node, whose id is its key and whose declaration
	// the workflow itself names.
