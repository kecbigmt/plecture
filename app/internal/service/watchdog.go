...
// State projects the report to the three-value display fact `tws status`
...
// for name. A session with no produced run-scoped tasks (already `tws down`,
...
// fact to a human is a policy decision that lives above tws (an owner's own
