...
// TestMain unsets TWS_SESSION_NAME before any test runs, so the suite stays
// hermetic when `go test` itself runs inside a tws pane (this repo's own
