...
// buildProviderBinaries compiles the Cradel CLI and the GitHub provider
...
func buildProviderBinaries(t *testing.T, root string) {
	...
	build("app", "./cmd/cradel", "cradel")
	build(filepath.Join("plugins", "github-provider"), "./cmd/cradel-github-provider", "cradel-github-provider")
