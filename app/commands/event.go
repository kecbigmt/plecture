...
// same and match the MCP tws_event_list "types" param's comma semantics.
...
func init() {
	...
	eventListCmd.Flags().StringArrayVar(&eventTypes, "type", nil, "Filter by type glob (repeatable and/or comma-separated, e.g. github.*)")
