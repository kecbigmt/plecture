// Command cradel-github-provider is the executable the shipped GitHub
...
import (
	...
	"github.com/cradel-dev/cradel/plugins/github-provider/internal/provider"
)

func main() {
	if err := run(os.Args[1:]); err != nil {
		fmt.Fprintln(os.Stderr, "cradel-github-provider:", err)
		os.Exit(1)
	}
}
...
func run(args []string) error {
	if len(args) == 0 {
		return fmt.Errorf("usage: cradel-github-provider <setup|cleanup> [flags]")
	}
