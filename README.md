...
go build ./plugins/session/runtime/src/channel-server/...
go build ./plugins/session/runtime/src/slack-adapter/...
```
...
go test ./plugins/session/runtime/src/channel-server/...
go test ./plugins/session/runtime/src/slack-adapter/...
```
